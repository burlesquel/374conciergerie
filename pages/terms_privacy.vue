<template>
    <div class="">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to 374 Conciergerie, Istanbul/Turkey.
                </p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to 374 Conciergerie, accessible from <a
                        href="https://374conciergerie.vercel.app" rel="external nofollow noopener"
                        target="_blank">https://374conciergerie.vercel.app</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: 374conciergerie@gmail.com</li>
        </ul>
    </div>
</template>